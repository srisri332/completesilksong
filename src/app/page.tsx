              ...
              <section className='mt-4 mb-8'>
                ...
                <div className='h-3 w-full rounded bg-stone-700'>
                  <div
                    className='h-3 rounded bg-[#ff4f56] transition-all'
                    style={{
                      width: `${(bossCheckedCount / bossTotalCount) * 100}%`,
                    }}
                  />
                </div>
              </section>
        ...
        <footer
          ...
          <div className='mx-auto max-w-5xl px-4 text-center text-xs text-stone-300'>
            <p className='mb-2'>
              ...
              <a
                href='https://hollowknight.wiki/w/Completion_(Silksong)'
                target='_blank'
                rel='noreferrer'
                className='text-[#ff4f56] hover:underline'>
                Hollow Knight Wiki
            ...
            <p className='mb-2'>
              Missing info or something broken? Please mail{" "}
              <a
                href='mailto:silksongchecklists@gmail.com'
                className='text-[#ff4f56] hover:underline'>
                silksongchecklists@gmail.com
              </a>
            </p>
            <p className='mb-2'>
